...
// this function actually hepls in taking data form a server through api but in my case t doesnot wrok properly so i comment it out.
    ...
    for (let index = 1; index < array.length; index++) {
        ...
        if (e.href.includes("/songs")) {
            ...
            cardContainer.innerHTML = cardContainer.innerHTML + `<div data-folder="${folder}" class="card">
                        ...
                        <img src="/songs/${folder}/Glory.jfif" alt="">
...
async function main() {
    ...
    document.querySelector(".close").addEventListener("click", () => {
        document.querySelector(".left").style.left = "-900%";
    })
